...
// FlagCompactSendThresholds defaults the composer to Compact and send at
...
var FlagCompactSendThresholds = featureflags.Register(featureflags.Flag{
	...
	Description: "Default the composer to Compact and send at context-usage warning thresholds.",
	Default:     false,
})
