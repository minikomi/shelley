...
export const en: TranslationKeys = {
  ...
  slackTestIntegration: "Test integration (webhook only)",
  slackBotTestError: "This is a Slack bot. This test only supports incoming webhooks.",
  slackMessageSent: "Message sent to {name}.",
  vmIntegrations: "VM integrations",
  viewIntegrationsAvailable: "View integrations available to this VM",
  refresh: "Refresh",
  attached: "Attached",
  loadingIntegrations: "Loading integrations…",
  noIntegrationsAttached: "No integrations are attached to this VM.",
  integrationName: "Name",
  integrationType: "Type",
  integrationScope: "Scope",
  team: "Team",
  personal: "Personal",
  manageOnExeDev: "Manage on exe.dev",
  loadingIntegrationDetails: "Loading integration details…",
  whatVmGets: "What this VM gets",
  provider: "Provider",
  accessVia: "Access via",
  exeDevManaged: "exe.dev managed",
  availableModels: "Available models",
  noProvidersEnabled: "No providers are enabled for this integration.",
  browseModelsInShelley: "Browse models in Shelley",
  repository: "Repository",
  copyCloneCommand: "Copy clone command",
  copy: "Copy",
  copied: "Copied",
  testPushNotification: "Test push notification",
  testPushNotificationDescription: "Send a test message to your devices through exe.dev.",
  testMessage: "Test message",
  sending: "Sending…",
  sendTestNotification: "Send test notification",
  testAccepted: "Test accepted. Check your devices.",
  comment: "Comment",
  connectionAndCli: "Connection & CLI",
  copyEndpoint: "Copy endpoint",
  copyEditCommand: "Copy edit command",
  cliEditOptions: "CLI edit options",
  howToUseIt: "How to use it",
  copyGuide: "Copy guide",
  integrationAccountNote: "Account details are redacted; changes require your exe.dev account.",
  allIntegrations: "All integrations",
  defaultTestMessage: "Test from Shelley",
  modelChat: "chat",
