...
export const es: TranslationKeys = {
  ...
  slackTestIntegration: "Probar integración (solo webhook)",
  slackBotTestError:
    "Esta integración es un bot de Slack. Esta prueba solo admite webhooks entrantes.",
  slackMessageSent: "Mensaje enviado a {name}.",
  vmIntegrations: "Integraciones de VM",
  viewIntegrationsAvailable: "Ver las integraciones disponibles para esta VM",
  refresh: "Actualizar",
  attached: "Conectadas",
  loadingIntegrations: "Cargando integraciones…",
  noIntegrationsAttached: "No hay integraciones conectadas a esta VM.",
  integrationName: "Nombre",
  integrationType: "Tipo",
  integrationScope: "Ámbito",
  team: "Equipo",
  personal: "Personal",
  manageOnExeDev: "Administrar en exe.dev",
  loadingIntegrationDetails: "Cargando detalles de la integración…",
  whatVmGets: "Lo que recibe esta VM",
  provider: "Proveedor",
  accessVia: "Acceso mediante",
  exeDevManaged: "administrado por exe.dev",
  availableModels: "Modelos disponibles",
  noProvidersEnabled: "No hay proveedores habilitados para esta integración.",
  browseModelsInShelley: "Explorar modelos en Shelley",
  ...
  testPushNotificationDescription:
    "Envía un mensaje de prueba a tus dispositivos mediante exe.dev.",
  testMessage: "Mensaje de prueba",
  sending: "Enviando…",
  sendTestNotification: "Enviar notificación de prueba",
  testAccepted: "Prueba aceptada. Revisa tus dispositivos.",
  comment: "Comentario",
  connectionAndCli: "Conexión y CLI",
  copyEndpoint: "Copiar endpoint",
  copyEditCommand: "Copiar comando de edición",
  cliEditOptions: "Opciones de edición de CLI",
  howToUseIt: "Cómo usarlo",
  copyGuide: "Copiar guía",
  integrationAccountNote:
    "Los detalles de la cuenta están ocultos; los cambios requieren tu cuenta de exe.dev.",
  allIntegrations: "Todas las integraciones",

  defaultTestMessage: "Prueba desde Shelley",
  modelChat: "chat",
  modelEmbeddings: "incrustaciones",
  modelTranscription: "transcripción",
  modelOther: "otros",
