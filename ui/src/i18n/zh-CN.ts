...
export const zhCN: TranslationKeys = {
  ...
  slackTestIntegration: "测试集成（仅限 Webhook）",
  slackBotTestError: "这是一个 Slack 机器人。此测试仅支持传入 Webhook。",
  slackMessageSent: "消息已发送到 {name}。",
  vmIntegrations: "VM 集成",
  viewIntegrationsAvailable: "查看此 VM 可用的集成",
  refresh: "刷新",
  attached: "已连接",
  loadingIntegrations: "正在加载集成…",
  noIntegrationsAttached: "此 VM 未连接任何集成。",
  integrationName: "名称",
  integrationType: "类型",
  integrationScope: "范围",
  team: "团队",
  ...
  loadingIntegrationDetails: "正在加载集成详情…",
  whatVmGets: "此 VM 可获得的内容",
  provider: "提供商",
  accessVia: "访问方式",
  exeDevManaged: "由 exe.dev 管理",
  availableModels: "可用模型",
  noProvidersEnabled: "此集成未启用任何提供商。",
  browseModelsInShelley: "在 Shelley 中浏览模型",
  repository: "仓库",
  copyCloneCommand: "复制克隆命令",
  copy: "复制",
  copied: "已复制",
  testPushNotification: "测试推送通知",
  testPushNotificationDescription: "通过 exe.dev 向你的设备发送测试消息。",
  testMessage: "测试消息",
  sending: "正在发送…",
  sendTestNotification: "发送测试通知",
  testAccepted: "测试已接受。请检查你的设备。",
  comment: "备注",
  connectionAndCli: "连接和 CLI",
  copyEndpoint: "复制端点",
  copyEditCommand: "复制编辑命令",
  cliEditOptions: "CLI 编辑选项",
  howToUseIt: "如何使用",
  copyGuide: "复制指南",
  integrationAccountNote: "帐户详情已隐藏；更改需要你的 exe.dev 帐户。",
  allIntegrations: "所有集成",

  defaultTestMessage: "来自 Shelley 的测试",
  modelChat: "聊天",
  modelEmbeddings: "嵌入",
  modelTranscription: "转录",
  modelOther: "其他",
